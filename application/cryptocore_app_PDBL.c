...
// Show the initial values if they are complete
	...
	printf("\n\nPoint Doubling Results : ");
	printf("\n\n");
	
	// read R_MDJ :
	
	printf("X_rmdj: 0x");
	for(i=0; i<ECMDPointDBL_512_test.prec/32; i++){
		printf("%08x", ECMDPointDBL_512_test.x_rmdj[i]);
	}
	printf("\n\n");
	printf("Y_rmdj: 0x");
	for(i=0; i<ECMDPointDBL_512_test.prec/32; i++){
		printf("%08x", ECMDPointDBL_512_test.y_rmdj[i]);
	}
	printf("\n\n");
	printf("Z_rmdj: 0x");
	for(i=0; i<ECMDPointDBL_512_test.prec/32; i++){
		printf("%08x", ECMDPointDBL_512_test.z_rmdj[i]);
	}	
